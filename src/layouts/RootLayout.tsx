    ...
    <>
      ...
      <main>
        ...
        <section
          ...
          <img className="w-20 animate-[to-orbit_70s_linear_infinite] drop-shadow-md drop-shadow-black" src="/satellite.svg" alt="satellite" />
          <Sphere />
        </section>
        <section 
        ...
        pt-60 pb-40 font-light">
          ...
          <img className="self-start drop-shadow-xl/50 drop-shadow-white animate-[float_6s_ease_infinite_alternate]" src="/astronaut.svg" alt="astronaut" />
        </section>
        <section className="py-30 backdrop-blur-xs bg-white/1">
          <Outlet />
        </section>
      </main>
      <Footer />
