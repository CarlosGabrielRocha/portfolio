...
const badgeProps: BadgePropsType = {
  ...
  git: {
    iconSrc: "/icons/git-icon.svg",
    alt: "git",
    shadowColor: "shadow-red-500",
    background: "bg-red-500/5",
  },
  postgresql: {
    iconSrc: "/icons/postgresql-icon.svg",
    alt: "postgresql",
    shadowColor: "shadow-blue-700",
    background: "bg-blue-700/5",
  },
  tailwind: {
    iconSrc: "/icons/tailwindcss-icon.svg",
    alt: "tailwind",
